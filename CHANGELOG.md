...
- eframe: レンダラーをglowに変更
  - wgpuだと一部環境で動かなくなったのでglowに戻しました。クラッシュはまだ調査中...
- bitflags系にビット演算のトレイトを実装

### デモプラグイン

（なし）

## [0.44.2](https://github.com/sevenc-nanashi/aviutl2-rs/releases/tag/0.44.2)
...
## [0.39.0](https://github.com/sevenc-nanashi/aviutl2-rs/releases/tag/0.39.0)
...
## [0.36.0](https://github.com/sevenc-nanashi/aviutl2-rs/releases/tag/0.36.0)
...
## [0.20.2](https://github.com/sevenc-nanashi/aviutl2-rs/releases/tag/0.20.2)
...
## <s>[0.20.0](https://github.com/sevenc-nanashi/aviutl2-rs/releases/tag/0.20.0)</s>
